...
// NO DEBE HABER NINGÚN ESPACIO O SALTO DE LÍNEA ANTES DEL <?php

// Evitar mostrar errores en producción
error_reporting(E_ALL); // Cambiar temporalmente para debug
...
try {
    ...
    // Solo mostrar página HTML si NO estamos en una redirección
    if (!headers_sent()) {
