...
<nav class="sidebar" id="sidebar">
    ...
    $indexUrl = $baseUrl . '/';
    $clientesUrl = $baseUrl . '/app/views/clientes/clientes.php';
    $productosUrl = $baseUrl . '/app/views/productos/productos.php';
    $facturaUrl = $baseUrl . '/app/views/factura/factura-registro.php';
    $almacenUrl = $baseUrl . '/app/views/inventario/inventario.php';
    $inventarioPUrl = $baseUrl . '/app/views/inventario/inventario-empleados.php';
    $facturacionUrl = $baseUrl . '/app/views/factura/facturacion.php';
    $cajaUrl = $baseUrl . '/app/views/caja/caja.php';
    $panelUrl = $baseUrl . '/app/views/gestion/panel-administrativo.php';
