    ...
    <div class="navegator-nav">
        ...
        <div class="admin-sections show" id="adminSections">
            ...
            <div class="admin-grid">
                ...
                <div class="admin-btn config" onclick="window.location.href='../empleados/empleados.php'">
            ...
            <div class="admin-grid">
                ...
                <div class="admin-btn inventario" onclick="window.location.href='../inventario/inventario-entrada-lista.php'">
                ...
                <div class="admin-btn inventario" onclick="window.location.href='../inventario/inventario-salida-lista.php'">
                ...
                <div class="admin-btn inventario" onclick="window.location.href='../inventario/registro-transacciones.php'">
            ...
            <div class="admin-grid">
                ...
                <div class="admin-btn reportes" onclick="window.location.href='../caja/cuadre-caja.php'">
                ...
                <div class="admin-btn reportes" onclick="window.location.href='../factura/cotizacion-registro.php'">
