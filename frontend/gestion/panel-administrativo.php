    ...
    <div class="navegator-nav">
        ...
        <div class="page-content">
            ...
            <div id="buttons">
                ...
                <!--<div id="div-users">
                    <button id="manager-users" onclick="window.location.href='../../frontend/gestion/usuarios-editar.php'">Administrar Usuarios</button>
                </div> -->
                <?php endif; ?>

                <?php if($permiso_empleados): ?>
                <div id="div-employees">
                    <button id="manager-employees" onclick="window.location.href='../../frontend/empleados/empleados.php'">Administrar Empleados</button>
                </div>
                <?php endif; ?>
                ...
                <div id="div-cashiers">
                    <button id="manager-cashiers" onclick="window.location.href='../../frontend/caja/cuadre-caja.php'">Cuadres de Caja</button>
                </div>
                <?php endif; ?>

                <?php if($permiso_cotizaciones): ?>
                <div id="div-cotizaciones">
                    <button id="cotizaciones" onclick="window.location.href='../../frontend/factura/cotizacion-registro.php'">Registro de Cotizaciones</button>
                </div>
                <?php endif; ?>

                <?php if($permiso_transferencias): ?>
                <div id="div-transactions-inventory">
                    <button id="transactions-inventory" onclick="window.location.href='../../frontend/inventario/registro-transacciones.php'">Transacciones de Inventario</button>
                </div>
                <?php endif; ?>

                <?php if($permiso_inventario): ?>
                <div id="div-inventory">
                    <button id="manager-inventory" onclick="navigateTo('../../frontend/inventario/inventario-gestion.php')">Administrar Inventario</button>
                </div>
                <?php endif; ?>
            </div>
