...
if (isset($_SESSION['last_activity']) && (time() - $_SESSION['last_activity'] > $inactivity_limit)) {
    session_unset();
    session_destroy();
    header("Location: ../../frontend/auth/login.php?session_expired=session_expired");
    exit();
}
...
if ($noCotizacion === null) {
    header('Location: ../../frontend/cotizacion/cotizacion-registro.php?error=missing_no');
    exit();
}
...
if ($resultInfo->num_rows === 0) {
    header('Location: ../../frontend/cotizacion/cotizacion-registro.php?error=not_found');
    exit();
}
...
<body>
    ...
    <script>
        function imprimir() {
            const cotizacionUrl = `../../reports/factura/recotizacion.php?cotizacion=<?php echo $noCotizacion; ?>`;
