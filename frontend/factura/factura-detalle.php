...
if ($numFactura === null) {
    header('Location: ../../frontend/factura/factura-registro.php?error=missing_numFactura');
    exit();
}
                            ...
                            <div class="invoice-card">
                                ...
                                <div class="action-buttons">
                                    ...
                                    ?>
                                        ...
                                        <button class="btn-primary" onclick="navigateTo('../../frontend/clientes/cuenta-avance.php?idCliente=<?php echo $facturaInfo['idCliente']; ?>')"><i class="fa-solid fa-money-check-dollar"></i> Avance a cuenta del cliente</button>
