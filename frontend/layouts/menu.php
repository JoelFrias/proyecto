...
<nav class="sidebar" id="sidebar">
    ...
    $indexUrl = $baseUrl . '/';
    $clientesUrl = $baseUrl . '/frontend/clientes/clientes.php';
    $productosUrl = $baseUrl . '/frontend/productos/productos.php';
    $facturaUrl = $baseUrl . '/frontend/factura/factura-registro.php';
    $almacenUrl = $baseUrl . '/frontend/inventario/inventario.php';
    $inventarioPUrl = $baseUrl . '/frontend/inventario/inventario-empleados.php';
